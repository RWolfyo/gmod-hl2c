...
-- PET_006
--
function Hl2c.Pet_Headcrab_Fast(owner)
	...
	then
		...
		then
		local pet = ents.Create("npc_fastzombie")
		...
		*/
		-- print("****")
		-- print("[pet] Created Fast Zombie pet for ".. owner:Nick())
		-- print("****")
		return pet
		else
		...
		*/
		-- print("****")
		-- print("[pet] Created Headcrab Fast pet for ".. owner:Nick())
		-- print("****")
		return pet
		end
	end
