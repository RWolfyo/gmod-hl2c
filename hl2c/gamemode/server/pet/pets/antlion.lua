function Hl2c.Pet_Antlion(owner)
	...
	then
		...
		local pet = ents.Create("npc_antlion")
		...
		if owner:Pet_GetLevel() > 9 then 
			...
			pet:SetKeyValue("spawnflags", "262144")
		else
		...
		--pet:Activate()
		pet:SetMaxHealth(130 + (owner:Pet_GetLevel() * 20))
		pet:SetHealth(130 + (owner:Pet_GetLevel() * 20))
		pet:SetOwner(owner)
		...
		*/
		-- print("****")
		-- print("[pet] Created Antlion pet for ".. owner:Nick())
		-- print("****")
		return pet
		end
	end
