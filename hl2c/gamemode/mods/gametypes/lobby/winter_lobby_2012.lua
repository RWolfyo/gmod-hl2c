if game.GetMap() == "keyfox_lobby_summer" or "winter_lobby_2012" then else return end
if SERVER then
...
/*
	local kill_one = ents.FindByClass("trigger_once_oc")
	for k, v in pairs( kill_one ) do
		v:Remove()
	end
	local kill_two = ents.FindByClass("trigger_multiple_oc")
	for k, v in pairs( kill_two ) do
	...
	*/
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_npcwar_final,5,1")
	end
	///////////////////////////////////////////////
	--	coop_npcwar2_final
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_npcwar2_final,5,1")
	end
	///////////////////////////////////////////////
	--	coop_npcwar3_final
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_atlantis_beta4_z2,5,1")
	end
	///////////////////////////////////////////////
	--	coop_swampthing_v6
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_swampthing_v6,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_sky_chase_tbr_v3,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_level01_dooms_entry_v1b,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_level02_traps_v1c,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level03_underground_1f5,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level04_across_the_darkness3a,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level05_diehard_fix2,5,1")
	end
	///////////////////////////////////////////////
	--	level06_the_base
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level06_the_base,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_level07_scary_house_v4,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level08_a_place_to_die_a4,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level09_choose_your_destiny_a1,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel level10_end_of_evil_a2,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_helicave_x_v2,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_meows_pyramid_z1,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_fleeravenholm_z1,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_underground_x_pgir_v2,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_meows_sewer_mania_r2,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel tbr_coop_thousand_antlions_v3b,5,1")
	end
	///////////////////////////////////////////////
	--	js_coop_shore
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_shore,5,1")
	end
	///////////////////////////////////////////////
	--	js_coop_subway_x_v6
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_subway_x_v6,5,1")
	end
	///////////////////////////////////////////////
	--	js_coop_thunder
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_thunder,5,1")
	end
	///////////////////////////////////////////////
	--	sg_coop_lockdown_b3
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel sg_coop_lockdown_b3,5,1")
	end
	///////////////////////////////////////////////
	--	js_coop_sewers_v5
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_sewers_v5,5,1")
	end
	///////////////////////////////////////////////
	--	js_coop_stargate_p9
	...
	d_trig_6 = ents.FindByName("dynamic6_trigger")
	d_trig_6[1]:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_stargate_p9,5,1")
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_coast_x_v5,5,1")
	end
	///////////////////////////////////////////////
	-- coop_city17_bouncy9
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_city17_bouncy9,5,1")
	end
	///////////////////////////////////////////////
	-- cl_coop_corridor_b3
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel cl_coop_corridor_b3,5,1")
	end
	///////////////////////////////////////////////
	-- cl_coop_doors_v2
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel cl_coop_doors_v2,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel cl_coop_laserquest_b2,5,1")
	end
	///////////////////////////////////////////////
	-- coop_npcwar3_aldo
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_npcwar3_aldo,5,1")
	end
	///////////////////////////////////////////////
	-- coop_123module_v2
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_123module_v2,5,1")
	end
	///////////////////////////////////////////////
	-- coop_great_evil
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_great_evil,5,1")
	end
	///////////////////////////////////////////////
	-- coop_manticore
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel coop_manticore,5,1")
	end
	///////////////////////////////////////////////
	-- js_coop_lh5_windows
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_lh5_windows,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel js_coop_ultraviolet_x_v2,5,1")
	end
	///////////////////////////////////////////////
	-- sg_coop_steamlab_b5
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel sg_coop_steamlab_b5,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_oldcanals,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_urbanchaos,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_silent_house,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_sevenhourwar_part1,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_desolate,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel oc_antlion_attack_01,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel oc_breakout,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel oc_wildfire,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel ocf_deadland,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_antlions_way,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_takeover,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_lvcoop_part1,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel ep1_oc_broken_escape_01,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel ep2_oc_broken_escape_02a,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel syn_bunker,5,1")
	end
	///////////////////////////////////////////////
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel d1_trainstation_01,5,1")
	end
	...
	v:Fire("addoutput", "OnTrigger servercommand,Command,changelevel cd0,5,1")
	end
	...
	hl2ch3_trigger[1]:Fire("addoutput", "OnTrigger servercommand,Command,changelevel metastasis_1,5,1")
	...
	ep1ch1_trigger[1]:Fire("addoutput", "OnTrigger servercommand,Command,changelevel ep1_citadel_00,5,1")
	...
	ep2ch2_trigger[1]:Fire("addoutput", "OnTrigger servercommand,Command,changelevel ep3_antarctic_01,5,1")
	...
	--local oceman = ents.FindByClass("filter_activator_name")
	--[[
	a = ents.FindByName("gnome_filter")
	for k, v in pairs(a) do

		if v:GetKeyValues()["filtername"] == "gnome*" then
		PrintTable(v:GetKeyValues())
		print(v:GetKeyValues()["filtername"].." \nFOUND IT \n")
		end

	end
	
	b = ents.FindByClass("logic_timer")
	for k, v in pairs(b) do

		if v:GetKeyValues()["targetname"] then
		--PrintTable(v:GetKeyValues())
		print(v:GetKeyValues()["targetname"].." \nFOUND IT \n")
		else
			PrintTable(v:GetKeyValues())
		end
	...
	for k, v in pairs(ents.FindByClass("npc_citizen")) do
		print(v:HasSpawnFlags(SF_NPC_NO_WEAPON_DROP))
		--PrintTable(v:GetKeyValues())
		v.flag = v:GetKeyValues()["spawnflags"]
		--print(v.flag)
		v.spawnflags = v.flag + 8192
		v:SetKeyValue("spawnflags", v.spawnflags)
		--v:SetKeyValue("spawnflags", tostring(v.spawnflags))
		--v:SetKeyValue("spawnflags", tostring(v.spawnflags))
		print(v.spawnflags)
	...
	*/
	...
	wmanager:SetKeyValue("maxpieces", "8")
	wmanager:SetKeyValue("weaponname", "weapon_ar2")
	wmanager:Spawn()
	wmanager:Activate()
	*/
	--local starkiller = ents.FindByClass("trigger_once_oc")
	--for k, v in pairs(starkiller) do
		--	xmasstar_physics
	--	v:Fire("addoutput", "OnTrigger xmasstar_physics,Kill,,0,1")
	...
	*/
	...
	/*
	local mynpc = ents.Create("pet_test")
	mynpc:SetPos(Vector(850, 296, 141))
	mynpc:Spawn()
	mynpc:Activate()
	mynpc:SetPos(Vector(850, 296, 141))
	*/
	/*
	if WE_HAVE_OC_SPAWN then
	
	else
	
		local add = ents.Create("info_player_start")
		add:SetPos(Vector(861, 221, 112))
		add:Spawn()
...
hook.Add("PlayerSpawn", "hl2cPlayerSpawn", function(pl)
	...
	if NEXTBOT_SPAWN then
	
	else
	
		--local mynpc = ents.Create("pet_hunter")
		--mynpc:SetPos(Vector(499, 453, 106))
		--mynpc:Spawn()
	end
end)
...
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightup
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightdn
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightup
CMaterial::DrawElements: No bound shader
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightdn
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightdn
CMaterial::DrawElements: No bound shader
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightrt
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightrt
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightlf
CMaterial::PrecacheVars: error loading vmt file for skybox/grimmnightrt
CMaterial::DrawElements: No bound shader



Attempting to create unknown particle system 'Snow' 
Attempting to create unknown particle system 'Snow' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'Voimala_fog' 
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'fog' 
...
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'fog' 
Attempting to create unknown particle system 'christmastree_glow' 
Attempting to create unknown particle system 'xmastree_shootingstar' 
Attempting to create unknown particle system 'xmastree_shootingstar' 
Attempting to create unknown particle system 'christmasstar1' 
Attempting to create unknown particle system 'xmastree_shootingstar' 
*/
