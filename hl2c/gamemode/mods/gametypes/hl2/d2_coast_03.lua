...
{Vector(-7187, -14451, 1035), Vector(-6605, -14348, 1291)}
...
-- VORTEX_POS = Vector(-5231.968750, -5333.949707, 849.695251)
VORTEX_POS = Vector(7300.753906, 12619.229492, 1958.133423)
local MAPSCRIPT = {}
...
function MAPSCRIPT:EntityRemoved(ent)
	...
	/*
	elseif ent:GetName() == "weapon_rpg" then
		WEAPON_RPG = true
		print("WEAPON_RPG")
	end
	*/
...
hook.Add("PlayerCanPickupWeapon", "hl2cPlayerCanPickupWeapon", function(ply, wep)
...
function MAPSCRIPT:InitPost()
	...
	for k, v in pairs(ents.FindByName("gunshipdown_music")) do
		v:SetKeyValue("message", "music/hl2_song32.mp3")
	end
	
	for k, v in pairs(ents.FindByName("tm_gatekeeper")) do
		v:Fire("addoutput", "OnEntitySpawned tm_gatekeeper,Kill,1,-1")
		v:Fire("addoutput", "OnEntitySpawned village_gate,Open,18,-1")
	end
