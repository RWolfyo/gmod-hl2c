include("gametypes/coastline.lua")
include("gametypes/cd.lua")
include("gametypes/ep2.lua")
include("gametypes/ep3.lua")
include("gametypes/episodic.lua")
include("gametypes/gmod.lua")
include("gametypes/hl1.lua")
include("gametypes/hl2.lua")
include("gametypes/hl2mp.lua")
include("gametypes/lobby.lua")
include("gametypes/lostcoast.lua")
include("gametypes/metastasis.lua")
include("gametypes/oc.lua")
include("gametypes/syn.lua")
-- include("gametypes/hl2.lua")
-- include("gametypes/hl2.lua")
...
function GameTypes:Add(name, tbl)
	...
	if self.Registered[mappedName] ~= nil then
		error("GameType name is already taken: " .. tostring(name))
	end
...
function GM:LoadGameTypes()
	hook.Run("Hl2c.LoadGameTypes", GameTypes)
end

function GM:SetGameType(gametype)
	local gametype = GameTypes:Get(gametype)
	if gametype == nil then
		error("Unable to find gametype: " .. tostring(gametype))
		return
	end
