...
local function showmenu()
	...
	for k,v in pairs(cl_inv) do
		...
		function DPanel1:Paint( w, h )
			draw.RoundedBox( 8, 0, 0, w, h, Color( 0, 0, 150 ) )
		end	
	...
	local ico_item = Material("icon16")
	sheet:AddSheet( "Items", list1, "icon16/user.png", false, false, "General Items" )
	sheet:AddSheet( "Equips", list2, "icon16/application_view_tile.png", false, false, "Things that go \"pew\"" )
	sheet:AddSheet( "Materials", list3, "icon16/palette.png", false, false, "Delicious Edibles" )
	sheet:AddSheet( "Crafting", list4, "icon16/application_view_tile.png", false, false, "Various Packages" )
end
-- concommand.Add("hl2c_inventory", function()
	-- showmenu()
-- end)